...
## 1) Lead Follow-up System (Corrected)
...
- These are exported workflow definitions and may require environment-specific credentials.
- HTTP endpoints are placeholders in the lead workflow (`https://httpbin.org/post`) and should be replaced for real delivery/logging.
